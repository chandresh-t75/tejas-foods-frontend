...
const Navbar = () => {
  ...
  return (
    <header
      className={`max-w-screen-2xl z-50 bg-white container mx-auto fixed top-0 left-0 right-0 transition-all duration-300 ease-in-out`}
    >
      <div
        className={`navbar z-50 xl:px-24 ${
          isSticky
            ? "shadow-md z-50  bg-white transition-all duration-300 ease-in-out"
            : ""
        }`}
      >
